...
const NavigateContent = () => {
  return (
    <BlurGlassDiv className="mobile-transition flex-1 rounded-t-sm shadow-md text-white lg:flex-none lg:w-[280px] xl:w-80 lg:pt-3 lg:flex lg:flex-col lg:rounded-md">
